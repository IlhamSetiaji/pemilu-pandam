                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        <div class="container mb-4">
                            <center><button class="btn btn-danger" type="button" id="countup">Mulai Hitung</button>
                            </center>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            @forelse ($pemilu->dapil as $dapil)
                                <div class="col-md-{{ $col }}">
                                    <center>
                                        <a href="{{ url('admin/' . Crypt::encrypt($dapil->id) . '/hasil/dapil') }}"
                                            class="btn btn-success">Hasil {{ $dapil->name }}</a>
                                    </center>
                                </div>
                            @empty
