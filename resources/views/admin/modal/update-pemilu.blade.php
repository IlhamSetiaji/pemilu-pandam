            ...
            <form id="createRecord" action="{{ url('admin/pemilu/'.$p->id.'/update') }}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker" name="start_date" value="{{ $p->start_date }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker" name="end_date" value="{{ $p->end_date }}">
